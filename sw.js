...
precacheAndRoute([{
  ...
  "revision": "1332f584fcab7157ccf0c2993c64ed59"
}, {
  "url": "manifest.webmanifest",
  "revision": "5d03db92b61b41342984bb8d2687327d"
}], {});
cleanupOutdatedCaches();
registerRoute(new NavigationRoute(createHandlerBoundToURL("index.html")));
registerRoute(/^https:\/\/.*\/data\/scripts\/[0-9]{1,2}\/.*\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/kklc\/[0-9]{4}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/grade\/[0-9]{2}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/heisig5\/[0-9]{4}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/heisig6\/[0-9]{4}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/jlpt\/[0-9]{1}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/kanken\/[0-9]{2}\.json\.bin$/i, new CacheFirst({
...
registerRoute(/^https:\/\/.*\/data\/wk\/[0-9]{2}\.json\.bin$/i, new CacheFirst({
